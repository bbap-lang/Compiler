...
public static class IArrayBuilderMethods{
    ...
    public static IArrayBuilderBlock<T> Concat<T>(this IArrayBuilderBlock<T> currentBlock, IReadOnlyCollection<T> collection) {
...
internal record ArrayBuilderCollection<T>(int Length, IArrayBuilderBlock<T> Parent, IReadOnlyCollection<T> Collection) : IArrayBuilderBlock<T>;